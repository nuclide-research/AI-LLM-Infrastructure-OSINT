...
- **[AI safety eval survey](case-studies/commercial/ai-safety-eval-cloud-survey-2026-05.md)** — **6 confirmed (smallest population in the 2026-05 series)**: 5 DeepEval / Confident AI + **1 Garak (NVIDIA adversarial harness)** at `149.56.22.24:5000` — Garak is normally CLI-only; network-exposed deployment is novel.
