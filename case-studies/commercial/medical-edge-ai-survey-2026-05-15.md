...
Three operator SPAs hosted on port 443 leak hardcoded API endpoints in their JavaScript bundles. The CDN-fronted-SPA → hardcoded-API pattern (Insight #19) holds in medical/edge AI as in commercial SaaS and PENTECH/SmartShop AI. One operator additionally hardcodes a **third-party public-test DCMjs server URL** in production — cross-tenant data-flow misconfig.
