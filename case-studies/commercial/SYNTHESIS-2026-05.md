...
| **Embedding Services** | **818 unique IPs (Shodan-driven) / 4 live-confirmed** | **144 Shodan queries (3 rounds) surfaced 818 unique IPs; 667 with ≥1 open port active. Shodan-dark pattern confirmed: TEI and infinity-embedding (port 7997) are invisible to Shodan HTML indexing.** Dominant platform: Xinference (484 hits, 98% title-confirmed), LocalAI (190 hits). Notable: Klinikken.ai medical AI — FastAPI proxy at 37.27.185.38:8001 bypasses Qdrant API key (32 collections, full CRUD unauth, GDPR/Helsepersonelloven HIGH). 307/818 IPs carry known CVEs; CVE-2023-44487 (HTTP/2 Rapid Reset) on 209 hosts enables auth-free DoS of embedding layer. Port 7997 = 100 hosts confirm infinity-embedding deployed at scale. Aliyun 28% of pool. | [embedding-services-cloud-survey-2026-05.md](embedding-services-cloud-survey-2026-05.md) |
