...
| [ollama-tier2-cloud-survey-2026-05.md](ollama-tier2-cloud-survey-2026-05.md) | Ollama (tier-2 expansion) | 1,019 instances across Scaleway/OVH/Linode (3.55M IPs) | 100% unauth — auth-off-default thesis reproduces operator-culture-independent (FR/CA/Akamai); **471 hosts (46.2%) load `:cloud` models** (358 minimax-m2.7, 289 deepseek-v4-pro, 22 gemini-3-flash-preview); **197-host Linode marketplace cluster** (Ollama 0.1.33, identical 5-model loadout, frozen Feb 2024); 20+ abliterated/uncensored finetunes (122B Qwen, Gemma 4 31B Claude-Opus-abliterated, Llama 3.3 Heretic) |
